...
6. QUANTITY RULE — when an invoice shows both "Quantity Ordered" and \
   "Quantity Shipped" (or "Qty Ord" / "Qty Ship") columns, ALWAYS use the \
   SHIPPED quantity in the quantity field. Ordered quantity is irrelevant \
